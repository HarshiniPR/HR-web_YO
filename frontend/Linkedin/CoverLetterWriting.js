// inputs from the form are stored in variables
...
// refrence catched of the buttons
...
function updatePreview() {
  ...
  const nameElement = document.getElementById("name-preview");
  const jobElement = document.getElementById("job-title-preview");
  const emailElement = document.getElementById("email-preview");
  const phoneElement = document.getElementById("phone-preview");
  const companyNameElement = document.getElementById("company-name-preview");
  const companyContactElement = document.getElementById(
    "company-contact-preview"
  );
  ...
  companyContactElement.textContent = contact;
  coverLetterElement.textContent = textLetter;
}
...
function generatePDF(e) {
  ...
  if (
    ...
    ui.msmAlert(
      `You must fill out the entire form to be able to generate the pdf. Don't be lazy..!`
    );
    return;
  }
